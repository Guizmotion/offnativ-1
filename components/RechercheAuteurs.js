...
import {Image, Text,TextInput,SectionList, View, StyleSheet, searchText,ScrollViewButton, Button,FlatList, TouchableOpacity,Modal,Pressable,TouchableWithoutFeedback} from 'react-native';
...
console.log('rechercheauteurs');
    return (
        ...
        <View style={{width: '100%', backgroundColor: '#fff', height: '100%'}}>
            ...
            <View style={{padding: 0, paddingTop: 40, flexDirection: 'row', width: '100%', backgroundColor: "#e8e8e8", flex: 1}}>
            ...
            <View style={styles.rechInitGlobal}>
                <FlatList
                    ...
                    renderItem={({item}) => <Text style={[styles.item, styles.itemInit ]}>{item.key}</Text>}
                />
            </View>
